...
def train():
    ...
    while True:
        ...
        reward, done, score, score_cows, score_knife = game.play_step(final_move,agent.n_games)
        ...
        if done or game.frame_iteration>200*(game.n_carrots+1):
            ...
            plot_scores_cows.append(score_cows)
            total_score += score
            mean_score = total_score / agent.n_games
            plot_mean_scores.append(mean_score)
            plot(plot_scores, plot_scores_cows, plot_scores_knife)
            print(score_cows)
